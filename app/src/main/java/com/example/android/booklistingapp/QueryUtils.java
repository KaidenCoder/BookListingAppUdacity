...
public final class QueryUtils {
    ...
    public static List<BookList> fetchBookListData(String requestUrl){
        ...
        // Extract relevant fields from the JSON response and create a list of {@link BookList}
        List<BookList> bookLists = extractFeatureFromJson(jsonResponse);

        // Return the list of {@link BookList}
        return bookLists;
    }
    ...
    private static List<BookList> extractFeatureFromJson(String bookListJSON) {
        ...
        // Catch the exception so the app doesn't crash, and print the error message to from the JSO the logs.
        try{
            ...
            for (int i = 0; i < bookListArray.length(); i++){
                ...
                // Get a single book at position i within the list of bookLists
                JSONObject currentBook = bookListArray.optJSONObject(i);
                ...
                String AuthorName = volumeInfo.optString("authors");
                ...
                // Create a new {@link BookList} object with the BookName, AuthorName, PublishedDate,
                // and Url from the JSON response.
                BookList bookList = new BookList(BookName, AuthorName, PublishedDate, Url);
